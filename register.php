...
<!-- ====================== PAGE STYLING ====================== -->
<style>
    /* dark red entire page background */
    body {
        background-color: #8B0000 !important;
    }

    /* push down below fixed header; adjust value to match your header height */
    .page-content {
        padding-top: 120px; /* change if your header is taller/shorter */
        padding-bottom: 60px;
    }

    /* Ensure the card is readable on dark background */
    .card {
        background: #ffffff;
    }

    /* make headings visible on dark background */
    h2 {
        color: #ffffff;
    }
</style>
