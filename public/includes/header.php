    ...
    <div class="sidebar-links">
        ...
        <div>
            ...
            <div style="padding-left:10px;">
                <a href="/inanna/public/collections/no-plus-one/">No Plus One</a>
                <a href="/inanna/public/collections/the-guest-list/">The Guest List</a>
                <a href="/inanna/public/collections/till-sunrise/">Till Sunrise</a>
            </div>
        </div>
...
<nav id="mainNav" class="navbar navbar-expand-lg main-navbar fixed-top">
    <div class="container custom-navbar d-flex align-items-center justify-content-between">
        ...
        <ul class="navbar-nav gap-lg-4 desktop-links">
            <li class="nav-item"><a class="nav-link<?= isActive('index.php') ?>" href="/inanna/public/">Home</a></li>
              ...
              <div class="mega-collections">
                <div class="mega-inner">
                  <div class="collection-list">
                    ...
                    <a class="collection-item is-active" href="/inanna/public/collections/no-plus-one/" data-title="No Plus One" data-images="https://picsum.photos/seed/npo1/360/480,https://picsum.photos/seed/npo2/360/480,https://picsum.photos/seed/npo3/360/480">No Plus One</a>
                    <a class="collection-item" href="/inanna/public/collections/the-guest-list/" data-title="The Guest List" data-images="https://picsum.photos/seed/gl1/360/480,https://picsum.photos/seed/gl2/360/480,https://picsum.photos/seed/gl3/360/480">The Guest List</a>
                    <a class="collection-item" href="/inanna/public/collections/till-sunrise/" data-title="Till Sunrise" data-images="https://picsum.photos/seed/ts1/360/480,https://picsum.photos/seed/ts2/360/480,https://picsum.photos/seed/ts3/360/480">Till Sunrise</a>
                  </div>
        ...
        <div class="navbar-brand mx-auto d-flex align-items-center justify-content-center">
            <img id="navLogo" class="navbar-logo" src="/inanna/public/assets/images/logo-inanna.avif" alt="Inanna">
        </div>
        
        <div class="d-flex align-items-center gap-2">

        <a href="cart.php" class="position-relative d-inline-block" aria-label="View cart">
                <img src="/inanna/public/assets/images/shopping-bag.svg" class="cart-img" alt="Cart">
            <?php if ($cartCount > 0): ?>
...
(function(){
  ...
  var isHome = (path === '/inanna/public/' || path === '/inanna/public/index.php' || path.endsWith('/inanna/public/') || path.endsWith('/inanna/public/index.php'));
