...
document.addEventListener("DOMContentLoaded", () => {
    ...
    /* -----------------------------------------------------
       JUST EDIT THESE IMAGE PAIRS BELOW ⬇
       ----------------------------------------------------- */
    const sliderImages = [
        {
            large: "assets/images/theguestlist/img-2.webp",
            small: "assets/images/theguestlist/img-5.webp",
            altLarge: "First Large",
            altSmall: "First Small"
        },
        {
            large: "assets/images/theguestlist/img-4.webp",
            small: "assets/images/theguestlist/img-6.webp",
            altLarge: "Second Large",
            altSmall: "Second Small"
        },
        {
            large: "assets/images/theguestlist/img-3.webp",
            small: "assets/images/theguestlist/image-7.webp",
