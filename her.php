...
<style>
    ...
    .image-wrapper { position: relative; width: 100%; aspect-ratio: 2 / 3; background-color: #330000; overflow: hidden; }
...
<main class="product-grid" id="productGrid">
    ...
    <div class="product-card" data-price="<?php echo $price; ?>" data-index="<?php echo $i; ?>">
        <div class="image-wrapper">
            <img src="https://via.placeholder.com/400x600/330000/FFFFFF?text=Item+<?php echo $i; ?>" class="product-image">
            <div class="wishlist-btn">♡</div>
        </div>
        <div class="brand-name">INANNA</div>
        <div class="product-title">LUXURY PIECE NO. <?php echo $i; ?></div>
