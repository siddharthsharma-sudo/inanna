...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,300;0,400;0,600;1,300;1,400;1,600&family=Montserrat:wght@300;400;500;600&display=swap"
        rel="stylesheet">
    ...
    <nav id="mainNav" class="navbar navbar-expand-lg main-navbar fixed-top <?= $header_class ?? '' ?>">
        <div class="container custom-navbar d-flex align-items-center justify-content-between">
                        ...
                        <div class="mega-inner">
                            <div class="collection-list">
                                ...
                                <a class="collection-item" href="the-guest-list.php" data-title="The Guest List"
                                    data-images="assets/images/theguestlist/img-1.webp,assets/images/theguestlist/img-2.webp,assets/images/theguestlist/img-3.webp">The
                                    Guest List</a>
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <?php if ($isLoggedIn): ?>
                    <div class="dropdown">
                        <a class="text-dark text-decoration-none dropdown-toggle" href="#" role="button" id="accountMenu"
                ...
                <button class="btn border-0 fs-1 mobile-hamburger d-lg-none" onclick="openSidebar()"
